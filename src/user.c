		...
		uint32_t color, const char *aiDll)
{
	...
	int i=b->participant_len - b->bot_len;
	while (i<b->participant_len
...
{
	int i = g_my_battle->participant_len - g_my_battle->bot_len;
	while (i < g_my_battle->participant_len
